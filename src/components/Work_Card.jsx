...
const Work_Card = (props) => {
  return (
    <><div data-tooltip-id='t_card' data-tooltip-content="This cards are not clikable only for showcase" className='flex animation-scale flex-row rounded-[20px] items-start shadow-[0_4px_24px_0_rgba(0,0,0,0.25)] border-1 bg-[#212123] cursor-pointer border-[#474747] p-6 w-[380px]'>
