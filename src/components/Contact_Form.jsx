  ...
  return (
    <form className='flex flex-col mt-12 w-full items-start' onSubmit={handleSubmit} >
        ...
        <div className='flex flex-col sm:flex-row w-full items-start'>
            ...
            <input name='email' value={formData.email} onChange={handlechange} type='email' className='border-1 border-[#383838] sm:m-3 mr-0 w-full h-[54px] pl-4 rounded-xl'placeholder='Email address' required></input>
        </div>
