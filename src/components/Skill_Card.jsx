   ...
   return (
    <div className='flex flex-col w-full mt-4  items-start'>
        ...
        <div className='rounded-full w-full h-[8px] flex items-center bg-[#383838]'>
            <div style={{width:`${props.percentage}`,transition:"width 2s cubic-bezier(0.4, 0, 0.2, 1)"}} className={`rounded-full h-full bg-gradient-to-l from-[#ffbb5c] to-[#ffdb70]`}></div>
