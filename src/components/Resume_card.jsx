  ...
  return (
    <div className='flex flex-col'>
        <div className='flex flex-row items-center justify-start'>
                ...
                <h3 className='font-bold text-[18px] pl-6'>Education</h3>
        </div>
        <div className='flex flex-row mt-8 '>
            ...
            <div className='flex flex-col items-start ml-9'>
                <div className='flex flex-row items-center '>
                    <img className='w-[60px] h-[60px]' src={props.logo}></img>
                    <h4 className='font-bold p-2 ml-3'>{props.institution}</h4>
                </div>
                <div className='font-semibold mt-1'> {props.title}</div>
                <div className=' text-[#fec160] '>{props.duration}</div>
                <div className='text-[#a8a8a8]'>{props.brief}</div>
