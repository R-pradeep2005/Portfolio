...
function App() {
  ...
  return (
    <div className="flex lg:flex-row   lg:items-stretch lg:bg-[#121212] flex-col items-stretch justify-center  ">
      <section className="flex flex-col relative md:transition-[width,height] p-6 md:duration-200  md:ease-in lg:max-h-[882px] md:mb-8 md:pl-8 lg:items-center md:items-start mb-4 justify-start bg-[#1e1e1f] border-1 border-[#313131] lg:w-[450px] lg:p-6 cursor-context-menu  rounded-[24px] ">
        <div className="flex lg:flex-col mt-8 sm:flex-row flex-col items-center pb-4 gap-8">
          <img
            data-tooltip-id="t_profile"
          ...
          <div className="flex flex-col  ">
            <h1
              ...
              data-tooltip-class-name="text-white"
              className="text-[26px] mt-6 mb-4 font-semibold cursor-pointer"
            >
              Pradeep Ravisankar
            </h1>

            <p
              data-tooltip-id="t_role"
              data-tooltip-content="Role"
              className=" rounded-[8px]  p-2 text-[12px] bg-[#2b2b2c] text-center"
            >
              Software Engineer
            </p>
        ...
        <div
          className={`${
            drop ? "h-[1.5px] w-full bg-[#313132] rounded-full mt-6" : "hidden"
          } lg:h-[1.5px] lg:w-full lg:bg-[#313132] lg:rounded-full lg:mt-6'  `}
        ></div>
        <div
          className={`${
            drop
              ? "lg:flex lg:flex-col md:grid md:grid-cols-2 md:gap-y-0 md:gap-12"
              : "hidden"
          }`}
        >
          <div
            data-tooltip-id="t_mail"
            data-tooltip-content="pradeepravisankar1@gmail.com"
          >
            <Info_Block
              src="/assets/icon-mail.svg"
              name="EMAIL"
              detail="pradeepravisankar1@gmail.com"
            />
          </div>
        ...
        <div className="w-full flex flex-row items-center justify-center gap-8 mt-6">
          ...
          <Linkedin_Icon link="https://www.linkedin.com/in/pradeepravisankar/" />
        </div>
        <div
          onClick={show_contact}
          className={`absolute right-0 top-0 lg:hidden`}
        >
          <Common_Button src="/assets/icon-view.svg" name="Show Contacts" />
        </div>
      </section>
      <main className="flex flex-col relative mb-12 lg:min-h-[882px] items-start w-full lg:ml-4 bg-[#1e1e1f] border-1 border-[#313131] h-[100%] rounded-[24px] p-6 pt-0 ">
        ...
        <div className="md:absolute md:block md:to-[-50px] hidden md:right-0">
          <Menu_Card />
        </div>
      </main>

      <div className="md:hidden bg-[#282829]/40 backdrop-blur-xl p-2 border-t-1 rounded-xl border-[#3d3d3d]  bottom-0 fixed left-0 flex flex-row justify-center w-full">
        <Menu_Card />
      </div>
    </div>
  );
