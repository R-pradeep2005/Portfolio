...
function App() {
  ...
  return (
      ...
      <div className='flex flex-row items-start bg-[#121212]'>
        <section className='flex flex-col items-center bg-[#1e1e1f] border-1 border-[#313131] cursor-not-allowed rounded-[24px] p-6'>
        ...
        <main className='flex flex-col relative items-start w-[100%] ml-4 bg-[#1e1e1f] border-1 border-[#313131] h-[100%] rounded-[24px] p-6 pt-0 '>
