...
const Resume = () => {
  return (
    ...
    <div className='w-full flex flex-row justify-center items-center mt-6'>
      <a   href='/assets/Pradeep_Ravisankar_resume.pdf' download className='flex flex-row p-6 h-[54px] ml-2 items-center shadow-md  border-1 hover:border-amber-200 cursor-pointer border-[#767676] bg-[#1e1e1f] rounded-[14px] 
    '>
 ...
 <p className=' pl-2 text-[16px] font-semibold text-[#ffdb70]'>Download Resume</p>   
     ...
     <a href='/assets/Pradeep_Ravisankar_resume.pdf' target='_blank'   className='flex flex-row p-6 h-[54px] ml-2 items-center shadow-md  border-1 hover:border-amber-200 cursor-pointer border-[#767676] bg-[#1e1e1f] rounded-[14px] 
    '>
